  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        targets: [
          target('ham-semi', 'Inner Hamstrings - Semitendinosus', 'hamstrings'),
          target('glute-rdl', 'Gluteus Maximus', 'glutes'),
        ],
        restSeconds: 120,
        defaultSets: 3,
        alternateWeek: 'A',
      ...
      },
      {
        ...
        targets: [target('ham-knee', 'Hamstrings - Knee Flexion', 'hamstrings')],
        restSeconds: 90,
        defaultSets: 3,
      },
      {
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        name: 'Chest-Supported DB Row',
        sectionLabel: 'Duel 1 · Horizontal',
        targets: [target('rhomboids-upper', 'Rhomboids & Mid-Trapezius', 'back')],
        restSeconds: 120,
        defaultSets: 3,
      },
      {
      ...
      },
      {
        ...
        sectionLabel: 'Finisher · Isolation',
        targets: [target('bi-cable', 'Biceps Brachii', 'biceps')],
        restSeconds: 60,
        defaultSets: 3,
      },
      {
        ...
        sectionLabel: 'Finisher · Isolation',
        targets: [
          target('tri-lat-med-upper', 'Triceps Brachii - Lateral & Medial heads', 'triceps'),
        ],
        restSeconds: 60,
        defaultSets: 3,
      },
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        name: 'Cable Crunches',
        targets: [target('abs-upper-lower', 'Rectus Abdominis - Upper Fibers', 'abs')],
        restSeconds: 60,
        defaultSets: 3,
      },
    ],
